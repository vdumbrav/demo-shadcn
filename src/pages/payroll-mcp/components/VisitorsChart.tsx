  ...
  return (
    <Card>
      <CardHeader className="pb-4 sm:pb-6">
        <div className="flex flex-col items-start justify-between gap-3 sm:flex-row sm:items-start sm:gap-0">
          ...
          >
            <ToggleGroupItem
              value="today"
              className="flex min-w-[40px] items-center gap-1 text-xs sm:min-w-[80px] sm:text-sm"
            >
            ...
            <ToggleGroupItem
              value="last-7-days"
              className="flex min-w-[40px] items-center gap-1 text-xs sm:min-w-[90px] sm:text-sm"
            >
            ...
            <ToggleGroupItem
              value="last-3-months"
              className="flex min-w-[40px] items-center gap-1 text-xs sm:min-w-[100px] sm:text-sm"
            >
